...
async def test_claim_release_db_outage_keeps_event_for_retry(
    ...
    original_release = ledger_db.release_gateway_message_ledger_dispatch_claim

    def broken_release(*args, **kwargs):
        raise RuntimeError("release db outage")

    ledger_db.release_gateway_message_ledger_dispatch_claim = broken_release
    ...
    ledger_db.release_gateway_message_ledger_dispatch_claim = original_release
