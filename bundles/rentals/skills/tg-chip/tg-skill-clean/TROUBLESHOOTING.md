...
```
Connection to root@178.63.60.99:22 exited: Connect failed: Connection refused
```
...
```
[DEFAULT]
ignoreip = 127.0.0.1/8 ::1 213.165.55.176
```
...
```
ssh-ed25519 host key mismatch for 178.63.60.99
```
...
**Решение:**
```bash
ssh-keygen -R 178.63.60.99
ssh root@178.63.60.99
```
