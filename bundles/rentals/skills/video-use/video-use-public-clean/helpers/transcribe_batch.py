...
Groq Whisper on each, writes normalized transcripts to
...
Usage:
    ...
    python helpers/transcribe_batch.py <videos_dir> --provider groq --language ru
"""
...
from transcribe import choose_provider, load_api_key, transcribe_one
