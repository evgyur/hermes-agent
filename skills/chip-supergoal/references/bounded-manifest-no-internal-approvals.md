...
Use when the user/operator asks to restart or rewrite a SuperGoal “до конца без апрувалов внутри” after an approval-card loop, especially for wallet/trading/gateway-control work.
