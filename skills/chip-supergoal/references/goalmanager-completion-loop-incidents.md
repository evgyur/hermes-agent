...
- If the user/operator says `Make supergoal` after this class of incident, treat it as a request to create a new files-first SuperGoal for the control-plane/root fix, not to resume the old completed goal.
