...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "Update when the current user request includes skill maintenance, or when "
        "skill maintenance is the smallest strict prerequisite for the requested "
        "outcome. Do not extend a completed assignment to patch or create a skill. "
        "For optional maintenance discovered after completion, stop and wait for a "
        "separate user request. Confirm with the user before creating/deleting.\n\n"
