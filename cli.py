...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin):
    ...
    def __init__(
        ...
        # HERMES_REASONING_EFFORT is intentionally ephemeral: scripted one-shot
        # executors (Project Flow/Shaw, CI probes) can request xhigh without
        # mutating the operator's persistent config or active gateway session.
        self.reasoning_config = _parse_reasoning_config(
            os.getenv("HERMES_REASONING_EFFORT", "")
            or os.getenv("HERMES_AGENT_REASONING_EFFORT", "")
