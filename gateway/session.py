...
class SessionSource:
    ...
    auto_thread_created: bool = False  # True when Hermes created a platform thread for this event
    auto_thread_initial_name: Optional[str] = None  # Initial name for an auto-created thread
