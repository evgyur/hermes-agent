...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _gptprof_token_metadata(self, access_token: str) -> dict:
        try:
            import base64
    ...
    def _gptprof_finish_device_code(self, slug: str, device_data: dict) -> dict:
        ...
        if token_meta.get("email"):
            profile["email"] = token_meta["email"]
        if token_meta.get("plan"):
            profile["plan"] = token_meta["plan"]
    ...
    def _subc_state_paths(self) -> tuple[_Path, _Path]:
        room = _Path(os.environ.get("SUBC_ROOM", "/home/hermes/.hermes/profiles/subc/room"))
        project = _Path(os.environ.get("SUBC_PROJECT", "/home/hermes/workspace/chip-subconscious"))
        return room, project
