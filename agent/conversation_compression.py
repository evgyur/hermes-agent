...
def compress_context(
    ...
    *,
    ...
    try:
        ...
        if todo_snapshot:
            # This is agent-owned continuity state, not a fresh user message.
            # Storing it as role=user makes gateways/context render it as if the
            # human typed it after compression, which is both confusing and can
            # accidentally re-trigger user-intent handling. Keep it in system role.
