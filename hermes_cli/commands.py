...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("title", "Set a title for the current session", "Session",
               args_hint="[name]"),
    CommandDef("recall", "Search prior sessions and show compact matching session cards", "Session",
               args_hint="<query>"),
    CommandDef("handoff", "Write a local continuation handoff for a topic, or transfer this CLI session to a platform", "Session",
               args_hint="<topic|platform>", cli_only=True),
