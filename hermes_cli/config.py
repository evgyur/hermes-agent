...
DEFAULT_CONFIG = {
    ...
    "display": {
        ...
        # best per platform:
        #   - Telegram is a durable mobile inbox and is often mirrored through
        #     userbot/Business tooling. Keep persistent progress/interim chatter
        #     off by default; otherwise internal fragments like "Need now..."
        #     or tool bubbles remain in chat history and can look misattributed.
